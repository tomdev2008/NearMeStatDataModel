...
public class GameAction extends ActionSupport {
	...
	public String init() {
		...
		gameList = service.getGameList(dto);
		ServletActionContext.getRequest().getSession().setAttribute(
				Constants.NEARME_SESSION_REPROT_DATA, gameList);
	...
	public String export() {
		...
		List<GameEntity> list = (List<GameEntity>) obj;

		HttpServletResponse response = ServletActionContext.getResponse();
		ExcelUtil eu = new ExcelUtil("游戏榜报表_" + DateUtil.getToday());

		try {
			eu.createSheets(1, new String[] { "游戏榜报表" });
