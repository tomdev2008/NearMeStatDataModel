 ...
 * @since 1.0, 2013-7-5
 */
public class TuijianAction extends ActionSupport {
	...
	public String init() {
		...
		tuijianList = service.getTuijianList(dto);
		ServletActionContext.getRequest().getSession().setAttribute(
				Constants.NEARME_SESSION_REPROT_DATA, tuijianList);
		
		LogUtil.log(dto, "相关推荐");
	...
	public String export() {
		...
		List<TuijianEntity> list = (List<TuijianEntity>) obj;

		HttpServletResponse response = ServletActionContext.getResponse();
		ExcelUtil eu = new ExcelUtil("相关推荐报表_" + DateUtil.getToday());

		try {
			eu.createSheets(1, new String[] { "相关推荐报表" });
			...
			for (int i = list.size() - 1; i >= 0; i--) {
				TuijianEntity entity = list.get(i);
	...
	public List<TuijianEntity> getTuijianList() {
		return tuijianList;
	}

	public void setTuijianList(List<TuijianEntity> tuijianList) {
