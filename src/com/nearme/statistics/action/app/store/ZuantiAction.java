...
public class ZuantiAction extends ActionSupport {
	...
	public String init() {
		...
		zuantiList = service.getZuantiList(dto);
		ServletActionContext.getRequest().getSession().setAttribute(
				Constants.NEARME_SESSION_REPROT_DATA, zuantiList);
	...
	public String export() {
		...
		List<ZuantiEntity> list = (List<ZuantiEntity>) obj;

		HttpServletResponse response = ServletActionContext.getResponse();
		ExcelUtil eu = new ExcelUtil("专题_" + DateUtil.getToday());

		try {
			eu.createSheets(1, new String[] { "专题" });
			...
			for (int i = list.size() - 1; i >= 0; i--) {
				ZuantiEntity entity = list.get(i);
	...
	public List<ZuantiEntity> getZuantiList() {
		return zuantiList;
	}

	public void setZuantiList(List<ZuantiEntity> zuantiList) {
		this.zuantiList = zuantiList;
	}
