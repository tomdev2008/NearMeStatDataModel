...
public class TypeselectAction extends ActionSupport {
	...
	private final String TAG = "分类精选";
	private StoreForm form;
	private List<StoreTypeselectEntity> typeselectList;
	...
	public String init() {
		...
		typeselectList = service.getTypeselectList(dto);
		ServletActionContext.getRequest().getSession().setAttribute(
				Constants.NEARME_SESSION_REPROT_DATA, typeselectList);
	...
	public List<StoreTypeselectEntity> getTypeselectList() {
		return typeselectList;
	}

	public void setTypeselectList(List<StoreTypeselectEntity> typeselectList) {
