...
public class AppAction extends ActionSupport {
	...
	public String init() {
		...
		appList = service.getAppList(dto);
		ServletActionContext.getRequest().getSession().setAttribute(
				Constants.NEARME_SESSION_REPROT_DATA, appList);
	...
	public String export() {
		...
		ExcelUtil eu = new ExcelUtil("应用榜报表_" + DateUtil.getToday());

		try {
			eu.createSheets(1, new String[] { "应用榜报表" });
