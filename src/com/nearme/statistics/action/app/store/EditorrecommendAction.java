 ...
 * @since 1.0, 2014-1-3
 */
public class EditorrecommendAction extends ActionSupport {
	private static final long serialVersionUID = 9038018083239546674L;

	private final String TAG = "小编推荐";
	private StoreForm form;
	private List<StoreEditorrecommendEntity> editorrecommendList;
	...
	public String init() {
		...
		editorrecommendList = service.getEditorrecommendList(dto);
		ServletActionContext.getRequest().getSession().setAttribute(
				Constants.NEARME_SESSION_REPROT_DATA, editorrecommendList);
	...
	public List<StoreEditorrecommendEntity> getEditorrecommendList() {
		return editorrecommendList;
	}

	public void setEditorrecommendList(
			List<StoreEditorrecommendEntity> editorrecommendList) {
		this.editorrecommendList = editorrecommendList;
	}
}
