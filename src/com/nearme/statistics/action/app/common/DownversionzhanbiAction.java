 ...
 */
public class DownversionzhanbiAction extends ActionSupport {
	private static final long serialVersionUID = 3344613703440222126L;
	
	private final String TAG = "版本占比";
	...
	public String init() {
		...
		List<ColumnValueEntity> list = service.getDownversionzhanbiList(dto);
		setColumn(type);
