 ...
 * @since 1.0, 2013-8-10
 */
public class NetzhanbiAction extends ActionSupport {
	...
	public String init() {
		...
		List<ColumnValueEntity> list = service.getNetzhanbiList(dto);
		setColumn(type);
