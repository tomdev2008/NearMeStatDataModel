...
public class ModuledownEntity implements java.io.Serializable {
	...
	private List<ModuledownChildEntity> list;
	...
	public List<ModuledownChildEntity> getList() {
		return list;
	}

	public void setList(List<ModuledownChildEntity> list) {
		this.list = list;
	}
}
