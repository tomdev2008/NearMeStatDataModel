...
public class FSResourcetypeEntity implements java.io.Serializable {
	...
	private long totalimei;
	private List<FSResourcetypeChildEntity> list;// 子list
	...
	public List<FSResourcetypeChildEntity> getList() {
		return list;
	}

	public void setList(List<FSResourcetypeChildEntity> list) {
		this.list = list;
	}
