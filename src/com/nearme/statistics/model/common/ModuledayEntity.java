 ...
 * @since 1.0, 2013-8-12
 */
public class ModuledayEntity implements java.io.Serializable {
	private static final long serialVersionUID = 4834611884603801850L;

	private Date statDate;// 时间
	private Date statEndDate;

	private long allstartImei;// 全终端启动IMEI数
	private long allnewImei;// 全终端新增IMEI数
	private long startImei;// 该终端启动IMEI数
	private float startRatio;// 该终端启动IMEI占比
	private long newImei;// 该终端新增IMEI数
	private float newRatio;// 该终端新增IMEI占比
