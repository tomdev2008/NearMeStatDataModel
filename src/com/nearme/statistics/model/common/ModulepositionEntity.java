...
public class ModulepositionEntity implements java.io.Serializable {
	...
	private List<ModulepositionChildEntity> list;
	...
	public List<ModulepositionChildEntity> getList() {
		return list;
	}

	public void setList(List<ModulepositionChildEntity> list) {
		this.list = list;
	}
