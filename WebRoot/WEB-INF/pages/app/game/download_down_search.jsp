...
<s:if test="downsearchList != null and downsearchList.size>0">
	<table id="dataSourceTbl" class="data-load" border="1" cellspacing="0"
		...
		<tr class="data-head">
			...
			<th onclick="" onMouseOver="this.bgColor='#FF9900'"
				onMouseOut="this.bgColor=''" style="cursor: hand" title="搜索直接下载">
				搜索直接下载
			</th>
			<th onclick="" onMouseOver="this.bgColor='#FF9900'"
				onMouseOut="this.bgColor=''" style="cursor: hand" title="搜索详情">
				搜索详情
			</th>
			<th onclick="" onMouseOver="this.bgColor='#FF9900'"
				onMouseOut="this.bgColor=''" style="cursor: hand" title="搜索详情下载">
				搜索详情下载
			</th>
		</tr>
		<s:iterator value="downsearchList">
			<tr>
				<td>
