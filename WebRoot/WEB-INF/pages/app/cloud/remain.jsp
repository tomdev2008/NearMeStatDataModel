				...
				<tr>
					<td>
						...
						<s:submit name="query" value="查询"
							action="cloud_remain_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="cloud_remain_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(1)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="存储帐号数">
						存储帐号数
					</th>
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="1X存储留存率">
						1X存储留存率
					</th>
					<th onclick="showTblChart(3)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="2X存储留存率">
						2X存储留存率
					</th>
					<th onclick="showTblChart(4)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="3X存储留存率">
						3X存储留存率
					</th>
				</tr>
