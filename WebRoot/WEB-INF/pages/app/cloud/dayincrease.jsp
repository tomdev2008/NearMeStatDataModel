				...
				<tr>
					<td>
						...
						<s:submit name="query" value="查询"
							action="cloud_dayincrease_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="cloud_dayincrease_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(1)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="当日进行存储的新增帐号总数">
						日新增存储帐号
					</th>
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="日增存储数量">
						日增存储数量
					</th>
				</tr>
				<s:iterator value="dayincreaseList">
					<tr>
						<td>
