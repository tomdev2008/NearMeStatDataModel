			...
			<table>
				<tr>
					<td>
						...
						-->
						版本
						<s:select id="appVersion" name="form.appVersion"
						    list="#{'-V2.1':'-V2.1','V2.1-V2.2':'V2.1-V2.2','V2.3+':'V2.3+'}" 
							onchange="changeLidu();">
						</s:select>
						粒度
						...
						<s:submit name="query" value="查询" action="store_push_query">
						</s:submit>
						<s:submit name="export" value="导出" action="store_push_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="推送对象">
						推送对象
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="统计时间段">
						统计时间段
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="推送形式">
						推送形式
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="推送细分用户">
						推送细分用户
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="发送push数">
						发送push数
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="到达IMEI数">
						到达IMEI数
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="到达率（%）">
						到达率（%）
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="查看IMEI数">
						查看IMEI数
					</th>
					<th onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="拒绝IMEI数">
						拒绝IMEI数
					</th>
				</tr>
				<s:iterator value="pushList">
					<tr>
						<td>
							${pushObj }
						</td>
