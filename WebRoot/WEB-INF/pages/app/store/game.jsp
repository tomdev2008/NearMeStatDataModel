	...
	<body class="context">
		...
		<s:form namespace="/app/store">
			...
			<table>
				<tr>
					<td>
						<input id="starttime" class="Wdate" type="text" name="form.startTime"
						...
						<s:submit name="query" value="查询" action="store_game_query">
						</s:submit>
						<s:submit name="export" value="导出" action="store_game_export">
						</s:submit>
					</td>
				</tr>
			</table>
