	...
	<body class="context">
			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="store_editorrecommend_query">
						</s:submit>
						<s:submit name="export" value="导出" action="store_editorrecommend_export">
						</s:submit>
					</td>
				</tr>
			</table>
		...
		<div class="data-load">
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<s:iterator value="editorrecommendList">
					<tr>
						<td>
