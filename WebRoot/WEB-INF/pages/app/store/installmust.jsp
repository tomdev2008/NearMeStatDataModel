	...
	<body class="context">
			...
			<table>
				<tr>
					<td>
						...
						-->
						粒度
						<s:select id="lidu" list="#{'DAILY':'日','MONTHLY':'月'}" name="form.lidu"
							onchange="changeLidu();">
						</s:select>
						版本
						...
						<s:submit name="query" value="查询" action="store_installmust_query">
						</s:submit>
						<s:submit name="export" value="导出" action="store_installmust_export">
						</s:submit>
					</td>
				</tr>
			</table>
		...
		<div class="data-load">
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<s:iterator value="installmustList">
					<tr>
						<td>
