				...
				<tr>
					<td>
						...
						<s:submit name="query" value="查询"
							action="zjb_tuiguanginstall_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="zjb_tuiguanginstall_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="连接成功次数">
						下载量
					</th>
				</tr>
				<s:iterator value="tuiguanginstallList">
					<tr>
						<td>
