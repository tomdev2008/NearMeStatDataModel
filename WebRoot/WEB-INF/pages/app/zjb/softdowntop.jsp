			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="zjb_softdowntop_query">
						</s:submit>
						<s:submit name="export" value="导出" action="zjb_softdowntop_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand"
						title="该时间段内通过装机宝后台自动更新升级的软件数量">
						下载次数
					</th>
				</tr>
				<s:iterator value="softdowntopList">
					<tr>
					    <td>
							${softname }
						</td>
...
function changeLidu() {
	...
	if (document.getElementById("lidu").value == "DAILY") {
		starttime = new Date().dateAdd('d', -2).format("yyyy-MM-dd");
