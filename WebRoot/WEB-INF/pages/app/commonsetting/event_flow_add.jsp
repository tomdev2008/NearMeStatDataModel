...
function suggestSubmit() {
	...
	<body class="context">
		...
		<s:form id="form_add" name="form" namespace="/app/commonsetting">
			<s:hidden id="hid_systemid" name="form.systemID" />
			<table>
				<tr>
					<td>事件流名称</td>
					<td><input type="text" id="txt_flowname" name="form.eventFlowName" /></td>
				</tr>
				<tr>
					<td valign="top">事件</td>
					<td>
...
<script type="text/javascript">
	...
	function add(){
		...
		document.getElementById("form_add").action="setting_eventflow_add.do";
