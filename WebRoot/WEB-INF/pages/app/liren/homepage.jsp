			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="liren_homepage_query">
						</s:submit>
						<s:submit name="export" value="导出" action="liren_homepage_export">
						</s:submit>
					</td>
				</tr>
			</table>
