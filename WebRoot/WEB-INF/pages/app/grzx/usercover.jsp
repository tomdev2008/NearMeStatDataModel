			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="grzx_usercover_query">
						</s:submit>
						<s:submit name="export" value="导出" action="grzx_usercover_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(1)" onMouseOver="this.bgColor='#FF9900'"
						...
						title="全平台该时间段启动IMEI数，包括软件商店、游戏堂、联运游戏等所有业务">
						全平台启动IMEI数
					</th>
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand"
						title="全平台该时间段启动帐号（统计系统统计到的新SSOID）数">
						全平台启动账号数
					</th>
					<th onclick="showTblChart(3)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand"
						title="全平台启动帐号数/全平台启动IMEI数（%）">
						账号覆盖率（%）
					</th>
				</tr>
				<s:iterator value="usercoverList">
					<tr>
						<td>
