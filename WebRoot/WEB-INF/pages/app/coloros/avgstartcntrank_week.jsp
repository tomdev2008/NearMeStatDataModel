	...
	<body class="context">
				...
				<tr>
					<td>
						...
						<s:submit name="query" value="查询"
							action="coloros_avgstartcntrank_queryweek">
						</s:submit>
		...
		<div class="data-load">
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<s:iterator value="avgstartrankweekList">
					<tr>
						<td>
							${appname }
						</td>
...
function showTblChart(cloumn) {
	var fcfCahrt = new FusionCharts("../../FCF/Pie3D.swf", "fcfCahrt",
			"800", "400", "0", "1");
	chartText = table2FCFPieChart("dataSourceTbl", cloumn, 100);
...
function jumpPage() {
	...
	window.location.href = "coloros_avgstartcntrank_initrank.do?form.systemID="
			+ systemID;
}
</script>
	</body>
