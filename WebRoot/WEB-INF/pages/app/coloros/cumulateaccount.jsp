			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="coloros_cumulateaccount_query">
						</s:submit>
						<s:submit name="export" value="导出" action="coloros_cumulateaccount_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(1)" onMouseOver="this.bgColor='#FF9900'"
						...
						title="截至该日期，使用过该版本的用户总数">
						累积用户
					</th>
				</tr>
				<s:iterator value="cumulateaccountList">
					<tr>
						<td>
