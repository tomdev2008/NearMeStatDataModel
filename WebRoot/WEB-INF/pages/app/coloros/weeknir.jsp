			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="coloros_weeknir_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="coloros_weeknir_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr style="background-color: #DEEBFB">
					...
					<th onclick="showTblChart(1)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="用户留存数">
						新增imei数
					</th>
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="用户留存率">
						NRR1(%)
					</th>
					<th onclick="showTblChart(1)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="用户留存数">
