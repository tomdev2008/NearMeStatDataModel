...
function suggestSubmit() {
	...
	<body class="context">
		...
		<div class="data-load" id="div_jobresult">
			<s:include value="wholeuserlifecycle_jobresult.jsp" />
		</div>
		<script type="text/javascript">
...
function queryJob() {
	$.ajax( {
		type : "POST",
		dataType : "html",
		url : 'common_wholeuserlifecycle_queryjob.do',
		data : $('#form').serialize(),
		success : function(result) {
			$("#div_listjob").html(result);
		},
...
function queryresult(jobID, resulttable, weidu, lidu) {
	$.ajax( {
		type : "POST",
		dataType : "html",
		url : 'common_wholeuserlifecycle_queryresult.do',
...
function deleteresult(jobID, resulttable, weidu, lidu) {
	$.ajax( {
		type : "POST",
		dataType : "html",
		url : 'common_wholeuserlifecycle_deleteresult.do',
		data : '&form.jobID=' + jobID 
		     + '&form.resulttable=' + resulttable
		     + '&form.weidu=' + weidu
		     + '&form.lidu=' + lidu,
...
function querySQL(){
	$.ajax( {
		type : "POST",
		dataType : "html",
		url : 'common_wholeuserlifecycle_querySQL.do',
		data : $('#form').serialize(),
		success : function(result) {
			$("#div_listjob").html(result);
		},
...
function exportresult(jobID,resulttable,weidu,lidu) {
	// 指定action
	document.getElementById('form_export').action = "common_wholeuserlifecycle_exportresult.do";
