			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="common_downweek_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="common_downweek_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr style="background-color: #DEEBFB">
					...
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="下载帐号数">
						下载帐号数
					</th>
