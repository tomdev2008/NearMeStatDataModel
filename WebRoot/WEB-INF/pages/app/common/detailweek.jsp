	...
	<body class="context">
			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="common_detailweek_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="common_detailweek_export">
						</s:submit>
					</td>
				</tr>
			</table>
		...
		<div class="data-load">
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<s:iterator value="detailWeekList">
					<tr>
						<td>
							${weekStr }
						</td>
...
function showTblChart(cloumn) {
	var fcfCahrt = new FusionCharts("../../FCF/ScrollLine2D.swf", "fcfCahrt",
			"1100", "350", "0", "1");
	chartText = table2FCFSingleLineChart4Week("dataSourceTbl", cloumn, "end-2-front");
