			...
			<table>
				<tr>
					<td>
					    ...
					    -->
						终端
						<myTags:ModelSelect showOppoOnly="true"
							clientID="form.model" clientName="form.model"
							addEmptyAll="false" value="${form.model}">
						</myTags:ModelSelect>
						<s:submit name="query" value="查询" action="common_moduleday_query">
						</s:submit>
						<s:submit name="export" value="导出" action="common_moduleday_export">
						</s:submit>
					</td>
				</tr>
			</table>
