				...
				<tr>
					<td>
						...
						<s:submit name="query" value="查询"
							action="common_detailmonth_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="common_detailmonth_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr style="background-color: #DEEBFB">
					...
					<th onclick="showTblChart(4)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="日均启动帐号数">
						日均启动帐号数
					</th>
					<th onclick="showTblChart(5)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="新增IMEI数">
						新增IMEI数
					</th>
					...
					<th onclick="showTblChart(7)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="新增帐号数">
						新增帐号数
					</th>
					<th onclick="showTblChart(8)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="日均新增帐号数">
						日均新增帐号数
					</th>
					<th onclick="showTblChart(9)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="平均活跃天数">
						平均活跃天数
					</th>
				</tr>
				<s:iterator value="detailMonthList">
					<tr>
						<td>
