			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="common_downremain_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="common_downremain_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr style="background-color: #DEEBFB">
					...
					<th onclick="showTblChart(2)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="DR X ： 该时间段下载用户（IMEI）在未来X单位时间留存量">
						DR1
					</th>
					...
					<th onclick="showTblChart(5)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="DRR X ： 该时间段下载用户（IMEI）在未来X单位时间留存比例">
						DRR1（%）
					</th>
					...
					<th onclick="showTblChart(8)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="新增下载IMEI数">
						新增下载IMEI数
					</th>
					<th onclick="showTblChart(9)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="NDR X ： 该时间段新增下载用户（IMEI）在未来X单位时间留存量">
						NDR1
					</th>
					...
					<th onclick="showTblChart(12)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="NDRR X ： 该时间段新增下载用户（IMEI）在未来X单位时间留存比例">
						NDRR1（%）
					</th>
				...
				<s:iterator value="downremainList">
					<tr>
						<td>
