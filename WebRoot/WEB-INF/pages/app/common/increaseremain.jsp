	...
	<body class="context">
				...
				<tr>
					<td>
						...
						<s:submit name="query" value="查询"
							action="common_increaseremain_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="common_increaseremain_export">
						</s:submit>
					</td>
				</tr>
			</table>
		...
		<div class="data-load">
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<s:iterator value="increaseRemainList">
					<tr>
						<td>
...
function changeLidu() {
	...
	if (document.getElementById("lidu").value == "DAILY") {
		...
		starttime = new Date().dateAdd('m', -7).format("yyyy-MM-dd");
	}
