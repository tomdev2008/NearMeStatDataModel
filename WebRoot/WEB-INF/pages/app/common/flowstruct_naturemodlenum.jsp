...
<s:if test="naturemodlenumList == null or naturemodlenumList.size==0">
	<b><font color="green" style="font-size: 14px"> ${errorinfo}</font>
	</b>
	<br>
</s:if>

<s:if test="naturemodlenumList != null and naturemodlenumList.size>0">
	<div class="title">
		自然模块数量总体及分析
	</div>
	...
	<table id="dataSourceTbl_total" class="data-load" border="1"
		...
		<tr class="data-head">
			...
			<s:iterator value="naturemodlenumList" begin="0" end="0">
	...
	<table id="dataSourceTbl_jobresult" class="data-load" border="1"
		...
		<s:iterator value="naturemodlenumList" begin="1">
			<tr>
				<td>
