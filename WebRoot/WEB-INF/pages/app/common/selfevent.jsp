			...
			<table>
				<tr>
					<td>
						...
						<s:submit name="query" value="查询" action="common_selfevent_query">
						</s:submit>
						<s:submit name="export" value="导出"
							action="common_selfevent_export">
						</s:submit>
					</td>
				</tr>
			</table>
			...
			<table id="dataSourceTbl" class="data-load" border="1"
				...
				<tr class="data-head">
					...
					<th onclick="showTblChart(3)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="留存IMEI数">
						事件激活IMEI数
					</th>
					<th onclick="showTblChart(4)" onMouseOver="this.bgColor='#FF9900'"
						onMouseOut="this.bgColor=''" style="cursor: hand" title="沉默IMEI数">
						事件激活次数
					</th>
				</tr>
				<s:iterator value="selfeventList">
					<tr>
						<td>
