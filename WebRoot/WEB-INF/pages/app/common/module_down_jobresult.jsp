...
<s:if test="moduledownList == null or moduledownList.size==0">
	<b><font color="green" style="font-size: 14px"> ${errorinfo}</font>
	</b>
	<br>
</s:if>

<s:if test="moduledownList != null and moduledownList.size>0">
	<div class="title">
		模块下载量分析
	</div>
	...
	<table id="dataSourceTbl_total" class="data-load" border="1"
		...
		<tr class="data-head">
			...
			<s:iterator value="moduledownList" begin="0" end="0">
	...
	<table id="dataSourceTbl_jobresult" class="data-load" border="1"
		...
		<s:iterator value="moduledownList" begin="1">
			<tr>
				<td>
					${statDatestr }
				</td>
